...
CURRICULUM_REL = "prod-memory/prod-extraction-v1.jsonl"
MANIFEST_REL = "prod-memory/prod-extraction-v1.manifest.json"
...
LOCAL_CURRICULUM = PACKAGE_ROOT / "data" / "prod-extraction-v1.jsonl"
LOCAL_MANIFEST = PACKAGE_ROOT / "data" / "prod-extraction-v1.manifest.json"
