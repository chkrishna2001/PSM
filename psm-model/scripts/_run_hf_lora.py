...
HF_PROFILES: dict[str, dict[str, str | int]] = {
    ...
    "v5m": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5m.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5m-qwen0.5b",
        "run_prefix": "hf-prod-v5m-qwen0.5b",
        "curriculum_profile": "hf-prod-v5m",
        "steps": 400,
        "recall_fraction": "0",
        "output_format": "json",
        "learning_rate": "1e-5",
    ...
    "v5n": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-qwen0.5b",
        "run_prefix": "hf-prod-v5n-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n",
        "steps": 400,
        "recall_fraction": "0",
        "output_format": "json",
        "learning_rate": "1e-5",
    ...
    "storage-v6": {
        ...
        "run_prefix": "hf-prod-storage-v6-qwen0.5b",
        "curriculum_profile": "hf-prod-storage-v6",
        "steps": 600,
        "save_steps": 200,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "storage-v7": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-storage-v7.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-storage-v7-qwen0.5b",
        "run_prefix": "hf-prod-storage-v7-qwen0.5b",
        "curriculum_profile": "hf-prod-storage-v7",
        "steps": 500,
        "save_steps": 250,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "storage-v9": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-storage-v9.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-storage-v9-qwen0.5b",
        "run_prefix": "hf-prod-storage-v9-qwen0.5b",
        "curriculum_profile": "hf-prod-storage-v9",
        "steps": 500,
        "save_steps": 250,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "storage-v10": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-storage-v10.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-storage-v10-qwen0.5b",
        "run_prefix": "hf-prod-storage-v10-qwen0.5b",
        "curriculum_profile": "hf-prod-storage-v10",
        "steps": 800,
        "save_steps": 400,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5o-sft": {
        ...
        "run_prefix": "hf-prod-v5o-sft-qwen0.5b",
        "curriculum_profile": "hf-prod-v5o",
        "steps": 300,
        "save_steps": 100,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5o-dpo": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5o-dpo.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5o-dpo-qwen0.5b",
        "run_prefix": "hf-prod-v5o-dpo-qwen0.5b",
        "curriculum_profile": "hf-prod-v5o-dpo",
        "steps": 100,
        "save_steps": 50,
        "recall_fraction": "0",
        "output_format": "json",
        ...
        "train_mode": "dpo",
        "dpo_beta": "0.15",
        "resume_prefix": "hf-prod-v5o-sft-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-v5o-sft-qwen0.5b/adapter",
    },
    "v5p": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5p.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5p-qwen0.5b",
        "run_prefix": "hf-prod-v5p-qwen0.5b",
        "curriculum_profile": "hf-prod-v5p",
        "steps": 200,
        "save_steps": 100,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5n-dpo": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo",
        "steps": 80,
        "save_steps": 40,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5n-dpo2": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo2-calibration.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo2-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo2-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo2-calibration",
        "steps": 40,
        "save_steps": 20,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5n-dpo3": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo3-calibration.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo3-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo3-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo2-calibration",
        "steps": 40,
        "save_steps": 20,
        "recall_fraction": "0",
    ...
    "v5n-dpo4": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo4-calibration.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo4-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo4-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo4-calibration",
        "steps": 40,
        "save_steps": 20,
        "recall_fraction": "0",
        "output_format": "json",
        ...
        "train_mode": "dpo",
        "dpo_beta": "0.08",
        "resume_prefix": "hf-prod-v5n-dpo3-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo3-qwen0.5b/adapter",
    },
    "v5n-dpo5": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo5-calibration.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo5-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo5-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo5-calibration",
        "steps": 15,
        "save_steps": 15,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5n-dpo6": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5n-dpo6-calibration.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5n-dpo6-qwen0.5b",
        "run_prefix": "hf-prod-v5n-dpo6-qwen0.5b",
        "curriculum_profile": "hf-prod-v5n-dpo6-calibration",
        "steps": 40,
        "save_steps": 20,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "recall-plan-v1": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-recall-plan-v1.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-recall-plan-v1-qwen0.5b",
        "run_prefix": "hf-prod-recall-plan-v1-qwen0.5b",
        "curriculum_profile": "hf-prod-recall-plan-v1",
        "steps": 300,
        "save_steps": 150,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "recall-plan-v2": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-recall-plan-v1.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-recall-plan-v2-qwen0.5b",
        "run_prefix": "hf-prod-recall-plan-v2-qwen0.5b",
        "curriculum_profile": "hf-prod-recall-plan-v1",
        "steps": 150,
        "save_steps": 75,
        "recall_fraction": "0",
        ...
        "learning_rate": "5e-6",
        "max_length": "1024",
        "resume_prefix": "hf-prod-recall-plan-v1-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-recall-plan-v1-qwen0.5b/adapter",
    },
    "recall-plan-v3": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-recall-plan-v1.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-recall-plan-v3-qwen0.5b",
        "run_prefix": "hf-prod-recall-plan-v3-qwen0.5b",
        "curriculum_profile": "hf-prod-recall-plan-v1",
        "steps": 520,
        "save_steps": 260,
        "recall_fraction": "0",
    ...
    "consolidation-v2": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v2.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v2-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v2-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v2",
        "steps": 150,
        "save_steps": 75,
        "recall_fraction": "0",
        "output_format": "json",
        "learning_rate": "5e-6",
        "max_length": "1024",
        "resume_prefix": "hf-prod-consolidation-v1-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v1-qwen0.5b/adapter",
    },
    "consolidation-v3": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v3.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v3-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v3-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v3",
        "steps": 100,
        "save_steps": 50,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "consolidation-v4": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v4.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v4-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v4-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v4",
        "steps": 120,
        "save_steps": 60,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "consolidation-v5": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v5.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v5-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v5-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v5",
        "steps": 150,
        "save_steps": 75,
        "recall_fraction": "0",
        "output_format": "json",
        "learning_rate": "5e-6",
        "max_length": "1024",
        "resume_prefix": "hf-prod-consolidation-v4-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v4-qwen0.5b/adapter",
    },
    "consolidation-v6": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v6.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v6-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v6-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v6",
        "steps": 60,
        "save_steps": 30,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "consolidation-v9": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v9.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v9-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v9-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v9",
        "steps": 130,
        "save_steps": 65,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "consolidation-v8": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v8.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v8-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v8-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v8",
        "steps": 90,
        "save_steps": 45,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "consolidation-v7": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-v6.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-v7-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-v7-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-v6",
        "steps": 60,
        "save_steps": 30,
        "recall_fraction": "0",
    ...
    "consolidation-dpo-v1": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-consolidation-dpo-v1.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-consolidation-dpo-v1-qwen0.5b",
        "run_prefix": "hf-prod-consolidation-dpo-v1-qwen0.5b",
        "curriculum_profile": "hf-prod-consolidation-dpo-v1",
        "steps": 60,
        "save_steps": 30,
        "recall_fraction": "0",
        "output_format": "json",
    ...
    "v5q-dpo": {
        "curriculum": "psm-model/prod-memory/data/hf-prod-v5q-dpo.jsonl",
        "out_dir": "psm-model/prod-memory/checkpoints/hf-prod-v5q-dpo-qwen0.5b",
        "run_prefix": "hf-prod-v5q-dpo-qwen0.5b",
        "curriculum_profile": "hf-prod-v5q-dpo",
        "steps": 80,
        "save_steps": 40,
        "recall_fraction": "0",
        "output_format": "json",
        ...
        "max_length": "2048",
        "train_mode": "dpo",
        # Raised from 0.15 (2026-07-05): the original value + a curriculum with two coarse
        # new DPO variants (missing_memory_reasoning, hallucinated_tags_fields) caused broad
        # output-quality collapse (6/10 -> 3/10, hallucinated non-schema fields on unrelated
        # fixtures). Reverted that checkpoint; retrying with a more conservative KL constraint.
        "dpo_beta": "0.3",
        "resume_prefix": "hf-prod-v5q-qwen0.5b",
        "resume_adapter": "psm-model/prod-memory/checkpoints/hf-prod-v5q-qwen0.5b/adapter",
    },
    "v5i": {
    ...
    if args.sync_code:
        rc._push_repo_files_via_tar(
            ...
            [
                ...
                "psm-model/prod-memory/scripts/build_v5q_dpo_curriculum.py",
                ...
                "psm-model/prod-memory/prod_memory/build_v5o_storage_dpo_rows.py",
                "psm-model/prod-memory/prod_memory/storage_rewards.py",
                "psm-model/prod-memory/data/hf-prod-conversation-gemma-all.jsonl",
                "psm-model/prod-memory/scripts/build_v5p_conversation_curriculum.py",
                "psm-model/prod-memory/data/hf-prod-v5p.jsonl",
                str(Path("psm-model/prod-memory/data/hf-prod-v5p.jsonl").with_suffix(".manifest.json")),
                "psm-model/prod-memory/scripts/build_v5n_conversation_curriculum.py",
            ],
            "/workspace/PSM",
            host=ssh_host,
            port=ssh_port,
