#!/usr/bin/env python3
"""Micro v3: resume 42k, target 42400, heavier repair copies, structural_loss=2."""
...
def main() -> int:
    ...
    artifact_rels = [
        ...
        "psm-model/data/curriculum/gate4-parse-repair-step-042800.jsonl",
    ...
    extra_env = {
        ...
        "TARGET_STEPS": "42400",
        "GATE4_CURRICULUM": "psm-model/data/curriculum/psm-50m-gate4-train-micro-v3.jsonl",
        "STRUCTURAL_LOSS_WEIGHT": "2",
        "PROMOTE_SPAN_WEIGHT": "4",
        "EVAL_EVERY": "200",
        "SAVE_EVERY": "200",
        "GATE4_PINNED_STEPS": "42000",
    }
    print("Starting micro v3 train...", flush=True)
    ...
    ok = ctl._verify_pod_job(
        ...
        tmux_session="psm-gate4", process_pattern="psm_model.train", label="micro-v3",
    )
