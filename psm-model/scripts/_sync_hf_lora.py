...
PROFILE_PREFIX: dict[str, str] = {
    ...
    "v5o-sft": "hf-prod-v5o-sft-qwen0.5b",
    "v5o-dpo": "hf-prod-v5o-dpo-qwen0.5b",
    "v5p": "hf-prod-v5p-qwen0.5b",
    "v5n-dpo": "hf-prod-v5n-dpo-qwen0.5b",
    "v5n-dpo2": "hf-prod-v5n-dpo2-qwen0.5b",
    "v5n-dpo3": "hf-prod-v5n-dpo3-qwen0.5b",
    "v5n-dpo4": "hf-prod-v5n-dpo4-qwen0.5b",
    "v5n-dpo5": "hf-prod-v5n-dpo5-qwen0.5b",
    "v5n-dpo6": "hf-prod-v5n-dpo6-qwen0.5b",
    "storage-v6": "hf-prod-storage-v6-qwen0.5b",
    "storage-v7": "hf-prod-storage-v7-qwen0.5b",
    "storage-v9": "hf-prod-storage-v9-qwen0.5b",
    "storage-v10": "hf-prod-storage-v10-qwen0.5b",
    "storage-v11": "hf-prod-storage-v11-qwen0.5b",
    "storage-v12": "hf-prod-storage-v12-qwen0.5b",
    "storage-v13": "hf-prod-storage-v13-qwen0.5b",
    "storage-v14": "hf-prod-storage-v14-qwen0.5b",
    "storage-v15": "hf-prod-storage-v15-qwen0.5b",
    "storage-v16": "hf-prod-storage-v16-qwen0.5b",
    "storage-cls-v1": "hf-prod-storage-cls-v1-qwen0.5b",
    "recall-plan-v1": "hf-prod-recall-plan-v1-qwen0.5b",
    "recall-plan-v2": "hf-prod-recall-plan-v2-qwen0.5b",
    "recall-plan-v3": "hf-prod-recall-plan-v3-qwen0.5b",
    "consolidation-v1": "hf-prod-consolidation-v1-qwen0.5b",
    "consolidation-v2": "hf-prod-consolidation-v2-qwen0.5b",
    "consolidation-v3": "hf-prod-consolidation-v3-qwen0.5b",
    "consolidation-v4": "hf-prod-consolidation-v4-qwen0.5b",
    "consolidation-v5": "hf-prod-consolidation-v5-qwen0.5b",
    "consolidation-v6": "hf-prod-consolidation-v6-qwen0.5b",
    "consolidation-v7": "hf-prod-consolidation-v7-qwen0.5b",
    "consolidation-v8": "hf-prod-consolidation-v8-qwen0.5b",
    "consolidation-v9": "hf-prod-consolidation-v9-qwen0.5b",
    "consolidation-dpo-v1": "hf-prod-consolidation-dpo-v1-qwen0.5b",
